...
<div class="box box-primary">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form role="form" action="{{$post->id}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="box-body">
            @if(count($errors) > 0)
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Title" value="{{$post->title}}" name="title">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail2" placeholder="answer" name="answer" value="{{$post->answer}}">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail3">Level</label>
                <input type="text" class="form-control" id="exampleInputEmail3" value="{{$post->level}}" name="level">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail4">Description</label>
                <textarea class="form-control" id="exampleInputEmail4" name="description">{{$post->description}}</textarea>   
            </div>
        </div>
        <!-- /.box-body -->
