...
<div class="box">
    ...
    <a style="float: right; margin-right: 20px;" href="{{ route('savePostGramar') }}" class="btn btn-success btn-add">Thêm</a>
                    ...
                    <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td class="sorting_1"><img width="70px;" src="/uploads/gramar/{{ $postgramar->thumbnail }}" /></td>
                                <td style="width: 50px;">
                                    <button type="button" class="btn btn-block btn-default btn-sm"><a href="update/{{$postgramar->id}}">Sửa</a></button>
                                </td>
                                <td style="width: 50px;">
                                    <button type="button" class="btn btn-block btn-default btn-sm"><a href="delete/{{$postgramar->id}}">Xóa</a></button>
                                </td>
                            </tr>
