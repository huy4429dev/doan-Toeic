                ...
                <section id="not-completed" class="toeic-milestone ui-tabs-panel ui-widget-content ui-corner-bottom" aria-labelledby="ui-id-2" role="tabpanel" aria-hidden="false" style="">
                    ...
                    <div class="milestone-grammar-wrapper clearfix">
                        ...
                        <div class="block-milestone milestone-grammar">
                            ...
                            <div class="inner">
                                <div class="name">
                                    <img src="/uploads/gramar/{{$gr1->thumbnail}}">
                                    <h3>{{$gr1->title}}</h3>
                                </div>
                    ...
                    <div class="milestone-grammar-wrapper clearfix">
                        ...
                        <div class="block-milestone milestone-grammar">
                            <div class="inner">
                                <div class="name">
                                    <img src="/uploads/gramar/{{$gr2->thumbnail}}">
                                    <h3>{{$gr2->title}}</h3>
                                </div>
                    ...
                    <div class="milestone-grammar-wrapper clearfix">
                        ...
                        <div class="block-milestone milestone-grammar">
                            <div class="inner">
                                <div class="name">
                                    <img src="/uploads/gramar/{{$gr3->thumbnail}}">
                                    <h3>{{$gr3->title}}</h3>
                                </div>
                    ...
                    <div class="milestone-grammar-wrapper clearfix">
                        ...
                        <div class="block-milestone milestone-grammar">
                            <div class="inner">
                                <div class="name">
                                    <img src="/uploads/gramar/{{$gr4->thumbnail}}">
                                    <h3>{{$gr4->title}}</h3>
                                </div>
                    ...
                    <div class="milestone-grammar-wrapper clearfix">
                        ...
                        <div class="block-milestone milestone-grammar">
                            <div class="inner">
                                <div class="name">
                                <img src="/uploads/gramar/{{$gr5->thumbnail}}">
                                    <h3>{{$gr5->title}}</h3>
                                </div>
