...
<main>
    <div class="main-content">
        <div class="container">
            <div class="main-head">
                <h2>TOEIC TEST PRO - Tổng hợp các đề thi toeic tốt nhất</h2>
            </div>
            <div class="container" style="padding-bottom: 60px;">
                <section class="ets-2019" id="ets-2019-2">
                    <div class="sub-title text-center pt-5 pb-4">
                        <img src="../uploads/image/de_thi_ets_2019.webp" alt="Đề thi TOEIC 2019 (Format Toeic mới): ETS 2019">
                        <h3 style="color: #87c52e;" class="pt-3 pb-4">Đề thi TOEIC 2019 (Format Toeic mới): ETS 2019</h3>
                    </div>
                    <div class="row">
                        @if(!$exams->isEmpty())
                        @foreach($exams as $exam)
                        <div class="col-sm-3">
                            <div class="toeic-item toeic-item-1">
                                <a href="thi-thu-toeic/{{$exam->id}}" class="link-wrap">
                                    <div class="image">
                                        <img src="../uploads/toeic/{{$exam->thumbnail}}" alt="{{$exam->title}}">
                                    </div>
                                    <div class="content">
                                        <h3 class="item-title">
                                            {{$exam->title}}
                                ...
                                <a class="pre-result" href='thi-thu-de-ets-toeic-2019-test-1/reports/'>
                                </a>
                            </div>
                        </div>
                        @endforeach
