            ...
            <div class="article-nav-wrapper">
                ...
                <div class="full-toeic-test box">
                    <div style="margin-bottom: 60px;">
                        <h1 class="text-center text-capitalize pt-5">John Robert Smith</h1>
                        <h4 class="text-center text-capitalize mb-4">Web Designer &amp; Developer, UX/UI Expert</h4>
                        <div class="about-avatar pt-4 text-center">
                            <img src="http://demo.ravelweb.com/material-cv/images/profile-pic.png" alt="">
                        </div>
